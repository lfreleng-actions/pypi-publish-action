...
use the `artefact_pattern` input to download all artifacts:
...
This downloads all artifacts matching the pattern and merges them into the
...
| artefact_pattern         | False    | Pattern to download artifacts by glob                    |
